...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_oem1bmh', 'template_cgat8lk', {
      from_name: form.name, to_name: 'Chris', from_email: form.email, to_email: 'christo.or@gmail.com', message: form.message,
    }, 'KLBo3c9Rkk6breEw')
    .then(
        () => {
          setLoading(false);
